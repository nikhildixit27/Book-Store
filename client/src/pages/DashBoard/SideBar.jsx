import { HiArrowSmRight, HiChartPie, HiInbox, HiOutlineCloudUpload, HiShoppingBag, HiOutlineLogin, HiHome } from 'react-icons/hi';
            ...
            <div className="w-20 md:w-64 h-screen text-gray-800 md:bg-transparent md:text-gray-800 border-r border-gray-300">
                <div className="p-4">
                    <div className="flex items-center mb-6">
                        ...
                        <span className="hidden md:inline-block md:text-gray-800 md:font-bold md:text-2xl">BookStore</span>
                    </div>
                    <ul>
                        <li className="mb-5">
                        ...
                        <li className="mb-5">
                            <Link to="/admin/dashboard/upload" className="flex items-center text-base hover:text-black pl-2">
                                ...
                                <span className="hidden md:inline-block">Upload Books</span>
                            </Link>
                        </li>
                        <li className="mb-5">
