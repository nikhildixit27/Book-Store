            ...
            <div className="min-h-screen mx-auto px-4 py-8">
                ...
                {cartItems.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <Link to="/shop" className="text-blue-500  hover:underline">Continue Shopping</Link>
                    </div>
                ) : (
                    <div className="overflow-x-auto">
                        ...
                        <Link to="/shop" className="text-blue-500 hover:underline mb-6 block text-center">Add More</Link>
